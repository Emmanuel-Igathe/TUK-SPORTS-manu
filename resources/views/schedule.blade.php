...
<body>
            ...
            <div class="header-top">
                ...
                <nav>
                    <ul class="nav-links">
                        ...
                        <li><a href="{{ route('schedule.index') }}" class="active">Events</a></li>
    ...
    <script>
        ...
        const eventsData = rawEvents.map(event => {
            const eventDate = new Date(event.date + 'T' + event.time);
            return {
                id: event.id,
                title: event.name,
                sport: event.sport.toLowerCase(), // Ensure lowercase for filtering
                date: eventDate,
                location: event.location,
                description: event.description,
                teams: [], // Placeholder as teams structure is currently not in DB
