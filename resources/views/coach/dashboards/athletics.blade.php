...
<head>
    ...
    <title>Athletics Dashboard - {{ $sportName }}</title>
    <style>
        /* Athletics Theme */
        :root { --primary-color: #FFD700; --accent-color: #0057B7; }
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .welcome-box { background: linear-gradient(135deg, #0057B7, #003366); color: white; padding: 30px; border-radius: 8px; margin-bottom: 30px; }
        ...
        .stat-val { font-size: 2rem; font-weight: bold; color: #0057B7; }
        ...
        .tab-btn.active { background: white; border-bottom-color: #0057B7; }
...
<body>
    ...
    <main class="main-section container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="stat-card">
                <h3 style="color: #FFD700;">Gold Medals</h3>
                <div class="stat-val" style="color: #FFD700;">{{ $sportDetails->wins ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3 style="color: #C0C0C0;">Silver Medals</h3>
                <div class="stat-val" style="color: #C0C0C0;">{{ $sportDetails->losses ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3 style="color: #CD7F32;">Bronze Medals</h3>
                <div class="stat-val" style="color: #CD7F32;">{{ $sportDetails->draws ?? 0 }}</div>
            </div>
            <div class="stat-card">
        ...
        @endif
            ...
            <form action="{{ route('coach.update-stats') }}" method="POST" style="display: flex; gap: 20px; align-items: flex-end; margin-top: 15px;">
                ...
                <button type="submit" class="btn btn-primary">Update Medals</button>
            </form>
