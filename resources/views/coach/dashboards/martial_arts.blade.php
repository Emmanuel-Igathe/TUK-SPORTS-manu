...
<head>
    ...
    <title>Martial Arts Dashboard - {{ $sportName }}</title>
    <style>
        /* Martial Arts Theme */
        :root { --primary-color: #8B0000; --accent-color: #000000; }
