...
<head>
    ...
    <title>Board Games Dashboard - {{ $sportName }}</title>
    <style>
        /* Board Games Theme */
        :root { --primary-color: #8B4513; --accent-color: #D2691E; }
    ...
    <main class="main-section container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-val">{{ $sportDetails->wins ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3>Runners Up</h3>
                <div class="stat-val">{{ $sportDetails->losses ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3>Draws</h3>
                <div class="stat-val">{{ $sportDetails->draws ?? 0 }}</div>
            </div>
            <div class="stat-card">
