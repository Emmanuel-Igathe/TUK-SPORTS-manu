...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <a href="{{ route('registration.index') }}" class="cta-button">Register Now</a>
        </div>
    </section>
                    ...
                    <div class="dual-login-container">
                        ...
                        <div class="login-option active" id="student-login">
                            ...
                            <form class="login-form" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label for="student-username">Student ID / Email *</label>
                                    <input type="text" id="student-username" name="email" placeholder="SCCJ/00651/2023 or email" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="student-password">Password *</label>
                                    <input type="password" id="student-password" name="password" placeholder="••••••••" required>
                                </div>
                                
                                <button type="submit" class="login-option-button">Login</button>
                            </form>
                        </div>
                        ...
                        <div class="login-option" id="coach-login">
                            ...
                            <form class="login-form" method="POST" action="{{ route('login') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="coach-username">Coach Email *</label>
                                    <input type="email" id="coach-username" name="email" placeholder="coach.email@tukenya.ac.ke" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="coach-password">Password *</label>
                                    <input type="password" id="coach-password" name="password" placeholder="••••••••" required>
                                </div>
    ...
    <section class="sports-categories">
        <div class="container">
            ...
            <div class="categories-grid">
                <!-- Ball Games -->
                <a href="{{ route('ball-games.index') }}" class="category-card">
                ...
                <!-- Board Games -->
                <a href="{{ route('board-games.index') }}" class="category-card">
                ...
                <!-- Throwing Games -->
                <a href="{{ route('throwing-games.index') }}" class="category-card">
                ...
                <!-- Athletics -->
                <a href="{{ route('athletics.index') }}" class="category-card">
                ...
                <!-- Martial Arts -->
                <a href="{{ route('martial-arts.index') }}" class="category-card">
