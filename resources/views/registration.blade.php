            ...
            <div class="header-top">
                ...
                <nav>
                    <ul class="nav-links">
                        ...
                        <li><a href="{{ route('registration.index') }}" class="active">Registration</a></li>
    ...
    <section class="registration-section">
        <div class="container">
            ...
            <div class="registration-container">
                ...
                <form class="registration-form" id="player-form" action="{{ route('registration.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select id="player-sport" name="player-sport" required>
                            ...
                            <option value="throwing-games">Throwing Games</option>
                        </select>
                        ...
                        <div class="password-requirements">
                            ...
                            <ul class="requirement-list" id="player-requirements">
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="player-length">⚪</span>
                                    At least 8 characters
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="player-special">⚪</span>
                                    At least 1 special character
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="player-digit">⚪</span>
                                    At least 1 digit
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="player-capital">⚪</span>
                ...
                <form class="registration-form" id="coach-form" style="display: none;" action="{{ route('registration.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-requirements">
                            ...
                            <ul class="requirement-list" id="coach-requirements">
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="coach-length">⚪</span>
                                    At least 8 characters
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="coach-special">⚪</span>
                                    At least 1 special character
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="coach-digit">⚪</span>
                                    At least 1 digit
                                </li>
                                <li class="requirement-item">
                                    <span class="requirement-icon" id="coach-capital">⚪</span>
                                    At least 1 capital letter
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateRequirementIndicators(password, requirementIds) {
                ...
                document.getElementById(requirementIds.length).textContent = requirements.length ? '✅' : '⚪';
                ...
                document.getElementById(requirementIds.special).textContent = requirements.special ? '✅' : '⚪';
                ...
                document.getElementById(requirementIds.digit).textContent = requirements.digit ? '✅' : '⚪';
                ...
                document.getElementById(requirementIds.capital).textContent = requirements.capital ? '✅' : '⚪';
            ...
            document.getElementById('player-form').addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    const sportToCategoryMap = {
                        'football': "{{ route('index') }}", // Placeholder
                        'basketball': "{{ route('index') }}", // Placeholder
                        'volleyball': "{{ route('index') }}", // Placeholder
                        'handball': "{{ route('index') }}", // Placeholder
                        'rugby': "{{ route('index') }}", // Placeholder
                        'hockey': "{{ route('index') }}", // Placeholder
                        'netball': "{{ route('index') }}", // Placeholder
                        'athletics': "{{ route('athletics.index') }}",
                        'martial-arts': "{{ route('martial-arts.index') }}",
                        'chess': "{{ route('board-games.index') }}",
                        'scrabble': "{{ route('board-games.index') }}",
                        'throwing-games': "{{ route('throwing-games.index') }}"
                    };
                    
                    // Get the redirect page based on the selected sport
                    const redirectPage = sportToCategoryMap[selectedSport] || "{{ route('index') }}";
            ...
            document.getElementById('coach-form').addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    window.location.href = "{{ route('index') }}"; // Placeholder for Admin
                }
            });
        });
    </script>
