    ...
    <div class="modal" id="registration-modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="registration-form" method="POST" action="{{ route('board-games.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="preferred-style" name="preferred-style" placeholder="e.g., Aggressive, Defensive, Balanced" value="{{ old('preferred-style') }}">
                    </div>
